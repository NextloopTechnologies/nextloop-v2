...
const faqsContent: IFAQ[] = [
  {
    ...
    "answer": "There’s no one size fits all answer. Mining companies use a wide range of tools. It’s why we recommend you work with a custom software development company like us."
  },
  {
    "id": 2,
        ...
        informationSection={
          <div className='max-w-[737px] flex flex-col justify-center pr-14'>
            ...
            <p className='text-lg font-normal gap-5'>
              ...
              performance. Save time and money by creating software that lets you 
              more effectively manage your operation. Our no-code solution gives you 
              the tech to solve your unique problems. We make the entire process simple, 
              cost-effective, and fast. What can we do for you?
            </p>
          </div>
        }
      />
