...
const faqsContent: IFAQ[] = [
  {
    ...
    "answer": "Healthcare software development involves creating customized software solutions to meet the specific needs of the healthcare industry, including patient management, EHRs, telehealth services, and compliance management, utilizing the latest technologies and regulations."
  },
  {
    "id": 2,
      ...
      <CustomPageHero
        ...
        titleChildren={
          <h1 className='text-white text-8xl uppercase font-bold text-center max-w-[1306px]'>
            ...
            {' '}software development transforming patient care
          </h1>
        }
        subtitle=''
        opacity='opacity-10'
