    ...
    <Layout>
      ...
      <div className='bg-white'>
        {cultureEvents.map((event, index) => (
          ...
          >
            <CultureSection {...event} reverse={index % 2 !== 0} />
          </div>
        ))}
      </div>
    </Layout>
...
const CultureSection = ({
  ...
  return (
    <section className='relative py-32 overflow-hidden'>
      ...
      <div
        className={`absolute top-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-orange-500/5 blur-3xl pointer-events-none ${
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 items-center gap-12'>
          ...
          <motion.div
            className={`relative lg:col-span-7 ${
              reverse ? 'lg:order-2 lg:pl-16' : 'lg:order-1 lg:pr-16'
            }`}
          ...
          >
            ...
            <div
              className={`absolute -z-10 w-full h-full rounded-[36px] border-2 border-orange-500/20
