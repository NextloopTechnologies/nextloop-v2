              ...
              {item.image &&
                (React.isValidElement(item.image) ? (
                  React.cloneElement(item.image, {
                    ...item.image.props,
                    className: `${
                      item.image.props?.className || ''
                    } dark:text-white text-black dark:group-hover:text-black group-hover:text-white w-24 h-24 text-orange-600`.trim(),
                  ...
                  React.createElement(item.image as any, {
                    className:
                      'w-24 dark:text-white text-black dark:group-hover:text-black group-hover:text-white h-24 text-orange-500',
                    size: 36,
                    color: 'currentColor',
                  })
                  ...
                  <Image
                    ...
                    alt={item.title}
                    fill
                    className='object-contain dark:text-white text-black dark:group-hover:text-black group-hover:text-white'
                  />
                ) : null)}
            </div>
