    ...
    <div className='relative h-96'>
      ...
      {React.isValidElement(image) ? (
        React.cloneElement(image, {
          ...
          } absolute inset-0 dark:text-white text-black dark:group-hover:text-white group-hover:text-black w-full h-full object-cover text-orange-600`.trim(),
        ...
        React.createElement(image as any, {
          className:
            'absolute inset-0 w-full h-full object-cover text-orange-500',
          size: 48,
          color:
            'currentColor dark:text-white text-black dark:group-hover:text-white group-hover:text-black',
        })
