            ...
            <div className='flex items-center gap-3'>
              {cat.image &&
                (React.isValidElement(cat.image) ? (
                  ...
                  <img src={cat.image as string} alt={cat.title} className='w-6 h-6 transition-all duration-200 dark:text-white text-black dark:group-hover:text-black group-hover:text-white' />
                ) : null)}
