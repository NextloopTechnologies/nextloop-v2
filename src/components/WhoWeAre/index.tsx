    ...
    <div className='flex flex-col lg:flex-row items-center justify-between gap-16 py-16 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto overflow-hidden'>
      ...
      <div className='w-full lg:w-1/2 flex justify-center lg:justify-end'>
        <div className='flex flex-col max-w-xl text-center lg:text-left'>
          ...
          >
            We offer software development outsourcing services that go beyond
            just creating code, thanks to our 8+ years of experience in the
            field. Our engineers are experts at using AI to update old systems
            and make digital ecosystems that are safe and can grow. We work with
            clients to fill up gaps in skills, speed up innovation, and help
            businesses flourish.
          </p>
          ...
          <div className='mt-10 grid grid-cols-1 sm:grid-cols-3 gap-8'>
            <div>
              ...
              <p className='mt-2 text-sm text-gray-600'>Successful Projects</p>
            </div>

            <div>
              <StatCounter end={80} suffix='+' />
              <p className='mt-2 text-sm text-gray-600'>Tech Professionals</p>
            </div>
