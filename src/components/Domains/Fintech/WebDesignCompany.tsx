...
const successSolutionContent = [
  ...
  },
  {
    ...
    descp:
      "Your website should reflect your brand's identity and values with a consistent style that aligns with your company's messaging and tone. A dedicated fintech website design company will work with you to create consistent and impactful branding throughout your various web pages.",
  },
  {
    image: getStaticImageData(fintechAssets.fintechWebDesignImg3),
    title: 'Optimised Structure',
    descp:
      "It's critical that every potential and existing customer can quickly find what they need from your website. People will leave your site and likely head to a competitor's if it's too challenging to find information. You can avoid losing your audience by optimising your design and structure.Web designers can ensure your website has a clear visual hierarchy, with essential information prominently displayed and less important information de-emphasised. This often means your value proposition and CTA (call to action) points are highlighted and displayed close to the top of the page.",
  },
  {
  ...
  return (
    <div className='py-[100px]'>
      <div className='flex flex-col text-center items-center'>
        ...
        >
          With so many web design companies around, how do you decide which is
          the best fit for your fintech company?
          <br />
          Your website is an essential part of your online presence. It is the
          first place that most customers will see, and their first impression
          of your site will influence whether or not they stick around to learn
          more. Clearly, an excellent website is a must. But discerning which
          company will provide these results is more challenging. To help, we've
          compiled a list of the most important elements of fintech web design.
        </p>
      </div>
