...
const timelineData = [
  {
    year: '2019',
    description:
      'Launched with a core engineering team of 4, delivering 6+ custom software projects.',
  },
  {
    year: '2020',
    description:
      'Transitioned to remote-first execution and achieved 90% client retention despite global disruption.',
  },
  {
    year: '2021',
    description:
      'Entered fintech and healthtech domains, grew the team by 60%, and launched cloud-native solution capabilities.',
  },
  {
    year: '2022',
    description:
      'Delivered 20+ scalable platforms, introduced DevOps & cloud optimization services.',
  },
  {
    year: '2023',
    description:
      'Partnered with high-growth startups, expanded staff augmentation services, and grew the engineering team.',
  },
  {
    year: '2024',
    description:
      'Participated at GITEX Asia, expanded cross-border collaborations, and surpassed 50+ cumulative successful project deliveries.',
  },
  {
    year: '2025',
    description:
      'Driving digital transformation with AI, automation, blockchain, and scalable cloud ecosystems.',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <p
            className={`text-semibold text-start leading-5 ${
      ...
      <div className='sticky top-0 h-screen flex flex-col items-center overflow-hidden'>
        ...
        <div className='w-full text-center px-6 pt-24  shrink-0'>
          ...
          <p className='mt-3 text-white/70 max-w-2xl mx-auto text-sm md:text-base leading-relaxed'>
            Nextloop Technologies started with a belief that technology should
            move businesses forward. From solving individual challenges to
            building scalable digital ecosystems across industries, every step
            was intentional.
          </p>
        </div>
      ...
      >
        ...
        <p
          className={`text-base leading-5 ${
            isOrange ? 'text-white/90' : 'text-gray-600'
          }`}
        >
          {item.description}
        </p>
  ...
  <div className='bg-[#0a0a0a] h-auto px-5 py-16'>
    ...
    <div className='mb-12 text-center'>
      ...
      <p className='mt-3 text-white/70 text-sm leading-relaxed'>
        Nextloop Technologies started with a belief that technology should move
        businesses forward. From solving individual challenges to building
        scalable digital ecosystems across industries, every step was
        intentional.
      </p>
    </div>
