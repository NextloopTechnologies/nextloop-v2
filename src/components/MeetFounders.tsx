  ...
  return (
    <div className="bg-white text-center px-6 py-20">
      ...
      <div className="max-w-2xl mx-auto mb-16">
        <p className="text-orange-500 text-xs font-bold uppercase tracking-[0.3em] mb-3">Meet the people</p>
        <h2 className={`${palette.fontSize.heading2.mobile} md:${palette.fontSize.heading2.desktop} text-black uppercase font-bold`}>
            ...
            <div className="group relative w-full rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default bg-black">
              <div className="relative w-full aspect-[3/4]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-left">
                  ...
                  <h3 className="text-white text-xl font-bold leading-tight">{founder.name}</h3>
                  <p className="text-orange-400 text-xs font-semibold uppercase tracking-widest mt-1">{founder.title}</p>
                </div>
              </div>
            </div>
