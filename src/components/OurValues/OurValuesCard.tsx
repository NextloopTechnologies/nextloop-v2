...
const OurServieceCard: FC<ServiceCardProps> = ({ heading, image }) => {
  return (
    <div
      className={
        'max-w-sm mx-auto bg-card border border-border rounded-sm shadow-lg p-6 flex justify-center items-center flex-col'
      }
    >
      ...
      <h2 className={'text-xl font-semibold text-foreground text-center'}>
        {heading}
        <hr
          className={'my-2 border border-1 border-orange-500 text-orange-500'}
        />
      </h2>
